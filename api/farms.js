...
// Update farm
router.put('/:farmId', authenticate, asyncHandler(async (req, res) => {
  const { farmId } = req.params;
...
// Delete farm
router.delete('/:farmId', authenticate, asyncHandler(async (req, res) => {
  const { farmId } = req.params;
...
router.get('/:farmId/export', authenticate, asyncHandler(async (req, res) => {
  const { farmId } = req.params;
...
router.post('/:farmId/import', authenticate, asyncHandler(async (req, res) => {
  const { farmId } = req.params;
...
router.delete('/:farmId/remove-all-data', authenticate, asyncHandler(async (req, res) => {
  const { farmId } = req.params;
...
router.get('/:farmId/stats', authenticate, asyncHandler(async (req, res) => {
  const { farmId } = req.params;
