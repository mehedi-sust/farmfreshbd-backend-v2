...
const storeProductsHandler = require('./store_products');
const farmsHandler = require('./farms');
const productCategoriesHandler = require('./product_categories');
const managementHandler = require('./management');
// const statsHandler = require('./stats');
// const adminHandler = require('./admin');
// const expensesHandler = require('./expenses');
// const investmentsHandler = require('./investments');
