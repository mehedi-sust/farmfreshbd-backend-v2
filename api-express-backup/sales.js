...
router.post('/', authenticate, asyncHandler(async (req, res) => {
  ...
  // Total expenses / total quantity in the batch
...
// Get sales (query parameter version) - GET /sales?farm_id=xxx
router.get('/', authenticate, asyncHandler(async (req, res) => {
  const { farm_id, product_id, start_date, end_date } = req.query;
...
router.post('/:id/reverse', authenticate, asyncHandler(async (req, res) => {
  const { id } = req.params;
